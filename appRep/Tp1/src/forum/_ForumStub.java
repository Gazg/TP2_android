...
/**
* forum/_ForumStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from E:/Documents/Florian/fac/M2/appRep/Tp1/forum.idl
* jeudi 13 novembre 2014 12 h 49 CET
*/

public class _ForumStub extends org.omg.CORBA.portable.ObjectImpl implements forum.Forum
{
  ...
  public boolean postMessage (forum.Message m) throws forum.Reject
  {
            ...
            try {
                ...
                forum.MessageHelper.write ($out, m);
                $in = _invoke ($out);
                ...
                if (_id.equals ("IDL:forum/Reject:1.0"))
                    throw forum.RejectHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public forum.Message getMessage (String title)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                forum.Message $result = forum.MessageHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public forum.Message[] messageList ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                forum.Message $result[] = forum.MessageSetHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
